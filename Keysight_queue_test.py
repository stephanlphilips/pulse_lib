...
awg4.awg_queue_config(4, 1)

awg1.awg_config_external_trigger(1,4000,1)
awg1.awg_config_external_trigger(2,4000,1)
awg2.awg_config_external_trigger(1,4000,1)
awg4.awg_config_external_trigger(4,4000,1)

awg1.awg.AWGqueueSyncMode(1,0)
awg1.awg.AWGqueueSyncMode(2,0)
awg2.awg.AWGqueueSyncMode(1,0)
awg4.awg.AWGqueueSyncMode(4,0)
