...
P4_Point_3 = lp.linspace(P3[0],P4[0],50, axis=0)
P5_Point_3 = lp.linspace(P3[1],P4[1],50, axis=0)


PSB_pulse.B4.add_block(0,1000, P0[0])
PSB_pulse.P5.add_block(0,1000, P0[1])
PSB_pulse.reset_time()
PSB_pulse.B4.add_block(0,1000, P1[0])
PSB_pulse.P5.add_block(0,1000, P1[1])
PSB_pulse.reset_time()
PSB_pulse.B4.add_ramp_ss(0,100, P1[0], P2[0])
PSB_pulse.P5.add_ramp_ss(0,100, P1[1], P2[1])
PSB_pulse.reset_time()
PSB_pulse.B4.add_ramp_ss(0,100, P2[0], P4_Point_3)
PSB_pulse.P5.add_ramp_ss(0,100, P2[1], P5_Point_3)
PSB_pulse.reset_time()
PSB_pulse.B4.add_block(0,10000, P4_Point_3)
PSB_pulse.P5.add_block(0,10000, P5_Point_3)
