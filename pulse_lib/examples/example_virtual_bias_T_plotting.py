...
def init_pulselib(awg1):
    ...
    set_channel_props(p, 'P1', compensation_limits=(-500,500), attenuation=2.0, delay=0)
    set_channel_props(p, 'P2', compensation_limits=(-250,250), attenuation=1.0, delay=0)
    set_channel_props(p, 'P3', compensation_limits=(-280,280), attenuation=1.0, delay=0)
