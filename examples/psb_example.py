...
PSB_pulse.B0.add_block(0,10,1000)
# PSB_pulse.B2.add_block(20,40,-1000)


PSB_pulse.M2.add_block(0,10,1000)
PSB_pulse.I_MW.add_block(0,10,1000)
PSB_pulse.I_MW.add_block(20,40,-1000)

PSB_pulse.P5.add_block(0,1000, 1500)
PSB_pulse.B4.add_block(0,1000, 1500)
PSB_pulse.reset_time()
PSB_pulse.P5.add_block(0,10, sweep_up_down)
PSB_pulse.B4.add_block(0,10, sweep_right_left)
PSB_pulse.P5.add_block(0,1000, 0)
PSB_pulse.B4.add_block(0,1000, 0)
PSB_pulse.reset_time()
PSB_pulse.P5.add_block(0,1000, -500)
PSB_pulse.B4.add_block(0,1000, -500)
PSB_pulse.reset_time()
PSB_pulse.P5.add_block(0,1000, -1500)
PSB_pulse.B4.add_block(0,1000, -1500)
PSB_pulse.reset_time()
